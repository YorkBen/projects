...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", choices=["uie-base", "uie-base-en", "uie-medical-base", "model_best", "uie-tiny", "uie-medium", "uie-mini", "uie-micro", "uie-nano"], default="uie-base", type=str, help="Select the pretrained model for few-shot learning.")
