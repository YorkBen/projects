...
if __name__ == '__main__':
    ...
    medical_data = load_medical_data(r'data/汇总结果_2409.json')
    results = process_by_regular(medical_data, load_mrnos(r'data/labeled_ind_1983.txt', False))
    write_to_excel(results, r'data/正则预测结果_补充.xlsx')
