...
class BiLSTMCRF(nn.Module):
    ...
    def __init__(
        ...
        self.word_embeddings = AlbertModel.from_pretrained('voidful/albert_chinese_base')
        # self.word_embeddings = BertModel.from_pretrained('BertModels/medical-roberta-wwm')
    ...
    def forward(self, input_ids, attention_mask):
        ...
        embeddings = all_hidden_states  # 倒数第二层hidden_states的shape
