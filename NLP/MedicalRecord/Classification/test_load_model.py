...
if __name__ == "__main__":
    dg = Diagnoser(r'output/models/diagnose/scaler_gbdt_临床特征.pkl', r'output/models/diagnose/gbdt_临床特征_0.7348.m')
    ...
    train_X, train_y = load_data(r'data/人机大赛_临床.txt', num_fields=120, separator='	', skip_title=True, cls_col=2, start_feature_col=2, end_feature_col=119)
