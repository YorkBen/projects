...
class Plot:
    ...
    def show_matrix(y_pred, y_true, classes_count, out_put_dir, fig_size=4, dpi=110, savefig=True):
        ...
        #
        # plt.figure(figsize=(fig_size, fig_size), dpi=dpi)
        # plt.text(4, 0, 'Here you are', family='fantasy', fontsize=12, style='italic', color='mediumvioletred')
        # plt.savefig(file_path[:-4]+ '_acc' + file_path[-4:])
        return file_path
    ...
    def get_roc(y_true, predicts, to_check_path_result, threshold_num=20, to_print=True):
        ...
        # fontsize = {'family': 'Times New Roman',
        #          'weight': 'normal',
        #          'size': 30,
        #          }
        ...
        return optimal_acc0, optimal_acc1, optimal_overall_acc, optimal_avg_acc, optimal_threshold