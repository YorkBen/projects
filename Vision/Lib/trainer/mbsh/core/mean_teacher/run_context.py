...
class TrainLog:
    ...
    def save(self):
        ...
        df.to_csv(self.log_file_path, encoding='gbk', index=False, sep=',')
...
class RunContext:
    ...
    def __init__(self, runner_file, run_idx):
        ...
        self.result_dir = "{root}/{runner_name}/{date:%Y-%m-%d}/{run_idx}".format(
            root='results',
        ...
        os.makedirs(self.transient_dir+'_ema', exist_ok=True)
